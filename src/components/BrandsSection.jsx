                ...
                <div className="lg:col-span-4 space-y-4">
                  ...
                  <div className="pt-2">
                    <button
                      ...
                      className="py-2.5 px-5 rounded-xl bg-slate-50 border border-brand-border hover:bg-slate-100 hover:border-blue-300 text-xs font-bold text-slate-800 transition-all flex items-center gap-1.5 shadow-sm"
                    >
